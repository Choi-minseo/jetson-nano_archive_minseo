...
###
```
3.  Look in to L4T-Readme  & ifconfig
```
...
###
```
4. Jetson Nano hangeul Installation
```
...
```
1."Jetson Nano Video Capture Image"
```
...
```
1. "NVIDIA photo download completed & Jupyter Notebook URL generation"
